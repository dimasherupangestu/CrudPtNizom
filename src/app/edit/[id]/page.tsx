...
const EditPage = () => {
  ...
  const { control, handleSubmit, errors, reset } = useValidate(); // Menggunakan useValidate untuk kontrol validasi
  ...
  const { data: productById, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      console.log("ress", responseById.data.data);
  ...
  const { mutate } = useMutation({
    mutationFn: async (data) => {
      const response = await apiAll.put(`sale/${id}`, data);
    ...
    <main>
      <div className="max-w-screen-xl max-h-screen mx-auto mt-6 px-4">
        ...
        <div className="px-4 py-2 border border-slate-200 rounded-md mt-2">
          <h1 className="text-xl font-bold my-4">Edit Sale News</h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="grid gap-6 mb-6 md:grid-cols-1">
              ...
              <FormInput
                ...
                control={control} // Menyertakan control untuk validasi
                type="date"
                placeholder="date"
                errors={errors} // Menyertakan errors untuk menangani pesan kesalahan
              />
              <FormInput
                label="Customer"
                name="customer_name"
